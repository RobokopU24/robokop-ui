...
function EnrichedQueries() {
  ...
  return (
    <Container sx={{ my: 6 }}>
      ...
      <p>
        This tool helps discover common connections between nodes. Given a list of input nodes, a
        relationship, and an output type, it will return a list of nodes that are best connected to
        the input nodes via the relationship.
      </p>
              ...
              <Button
                ...
                onClick={async () => {
                  const csvConfig = mkConfig({
                    ...
                    filename: 'enrichment_analysis_results',
                  })

                  const jsonToCsvString = (json: any) => generateCsv(csvConfig)(json)

                  const csvObj = results.map(
                    ({ id, name, p_value }: { id: string; name: string; p_value: number }) => [
                      id,
                      name,
                      p_value,
                    ],

...
export default function ResultExplorer({ answerStore }) {
  ...
  function drawAnswerGraph() {
    ...
    const trimmedNodes = sortedNodes.slice(
      0,
      answerStore.showNodePruneSlider ? debouncedTrimmedNodes : undefined
    );
    ...
    edge.current = edge.current
      ...
      .join(
          ...
          enter
            ...
            .call((e) =>
              e
                ...
                .call((eLabel) =>
                  eLabel.append('title').text((d) => stringUtils.displayPredicate(d.predicate))
                )
            )
            .call((e) =>
              e
        ...
        (update) =>
          update
            .call((e) => e.select('title').text((d) => stringUtils.displayPredicate(d.predicate)))
            .call((e) =>
              e
                .select('text')
                .select('textPath')
  ...
  return (
    <Paper id="resultExplorer" elevation={3}>
      ...
      {answerStore.metaData && (
        <ResultMetaData metaData={answerStore.metaData} result={answerStore.resultJSON} />
      )}

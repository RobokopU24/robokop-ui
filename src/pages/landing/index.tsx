      ...
      <MainGrid numberOfRows={7}>
        ...
        <Section title="Overview" hideTitle index={0}>
          ...
          <CardContainer>
            <Card title="Ask a Question" href="/welcome" icon={<QueryIcon />} gradient="blue">
              <p>
                Use the ROBOKOP Question Builder to construct a new query, then use the
        ...
        <Section title="Citations" index={2}>
          ...
          <CitationList>
            ...
            <li>
              ...
              answering. Bioinformatics 2019;pii:btz604. doi: 10.1093/bioinformatics/btz604.{' '}
        ...
        <Section title="License" index={4}>
          <p>
            ...
            . Both resources make use of open-source primary data sources. While we make every
            effort to ensure that those sources can be freely ingested and redistributed, we
            encourage users to review and comply with the specific license terms applicable to each
            source. Furthermore, copyright remains with the respective originators, contributors,
            and maintainers of the primary data sources. This resource does not claim ownership of
            such intellectual property unless explicitly stated. The open-source ROBOKOP system,
            including the ROBOKOP KG, is provided &quot;as is,&quot; without warranties or
            guarantees of any kind. The creators, maintainers, and distributors of the original
            primary data sources and derivative works disclaim any liability for errors, omissions,
            or misuse of the data. Users assume all responsibility for ensuring that the data
            sources are suitable for their specific applications and comply with all applicable

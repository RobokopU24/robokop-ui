...
export const AcronymTagline = () => {
  return (
    <p className={styles.acronymTagline}>
      ...
      <span className={styles.largeLetter}>o</span>ver <span className={styles.largeLetter}>b</span>
      iomedical <span className={styles.largeLetter}>o</span>bjects linked in{' '}

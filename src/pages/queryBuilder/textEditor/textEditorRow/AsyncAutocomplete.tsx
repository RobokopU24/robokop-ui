...
export function AsyncAutocomplete<T = any>({
  ...
  const interactionKeyDownHandler = refProps.onKeyDown as
      ...
      <TextField
        ...
        onFocus={(e) => {
          if (
            ...
            (!inputValue && dataSources.some((s) => s.options && s.options.length > 0))
          ) {
            setOpen(true)
          }
          onFocus?.(e)
                ...
                optionsWithGroups.map((item, visualIndex) => {
                  ...
                  return (
                    <StyledListItem
                      ...
                      disabled={isDisabled}
                      onClick={() =>
                        selectableIdx !== undefined && handleOptionClick(option, selectableIdx)
                      }
                    ...
                    >
                      {renderOption ? (
                        ...
                        <ListItemText
                          primary={
                            highlightMatches ? (
                              <HighlightText text={getOptionLabel(option)} query={inputValue} />
                            ) : (
                          ...
                          secondary={
                            option.subText ? (
                              highlightMatches ? (
                                <HighlightText text={option.subText} query={inputValue} />
                              ) : (
                                option.subText
                              )
                            ) : undefined

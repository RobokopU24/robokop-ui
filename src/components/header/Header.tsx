...
function Header() {
  ...
  const openSupportMenu = (event: React.MouseEvent<HTMLElement>) => setSupportAnchorEl(event.currentTarget);
  ...
  const openExploreMenu = (event: React.MouseEvent<HTMLElement>) => setExploreAnchorEl(event.currentTarget);
  ...
  const openAboutMenu = (event: React.MouseEvent<HTMLElement>) => setAboutAnchorEl(event.currentTarget);
  ...
  return (
    <AppBar position="relative" className="header">
      <Toolbar id="headerToolbar">
        ...
        <Button className="nav-link" id="about-button" aria-controls={aboutMenuOpen ? "about-menu" : undefined} aria-haspopup="true" aria-expanded={aboutMenuOpen ? "true" : undefined} onClick={openAboutMenu}>
          About
        </Button>
        <DropdownMenu
          id="about-menu"
